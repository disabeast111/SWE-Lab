...
public class TestSimulator {
  ...
  /**
   * Test to make sure the sim is populating the environment It goes through every
   * cell and adds together all the lifeforms and weapons it comes across
   * 
  ...
  /**
   * Test to make sure contexts are changing on the board when the timer runs Test
   * adds a weapon to every cell so wherever lifeform is placed it will change
   * state when updateTime is called as it will grab a weapon
   * 
   * @throws RecoveryRateException
   */
  @Test
